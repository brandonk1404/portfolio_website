/**
 * Series hero carousels: glitch (Videoverse video ping-pong), greenery (Earthly), chromatic (Chromatic Fragments).
 */
(function (window) {
  'use strict';
  ...
  function runVideoverseGlitch(options) {
  ...
  window.SeriesHeroCarousel = {
    runVideoverseGlitch: runVideoverseGlitch,
