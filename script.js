(function () {
  ...
  var heroSlides = [
    ...
    { src: 'images/garden_fullview.jpg',                   title: 'Garden',                                         medium: 'Photographic Print',    position: 'center top' },
    { src: 'images/room_depth_fullview.jpg',                   title: 'Room Depth',                                     medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/sight_by_sound_fullview.png',   title: 'Sight By Sound Packaging',                       medium: 'Digital Illustration',  position: 'center center' },
    ...
    { src: 'images/lunar_bookmark_thumb.png',     title: '2024 Lunar New Year Bookmark',                   medium: 'Digital Illustration',  position: 'center center' },
    ...
    { src: 'images/chromatic_thumb.png', title: 'Chromatic Fragments — Exhibition Poster',       medium: 'Digital Illustration',  position: 'center center' },
    ...
    { src: 'images/laundry_thumb.jpg',          title: 'What Your Laundry Says About Your Life',         medium: 'Digital Illustration',  position: 'center top' },
    { src: 'images/pastry_parlour_fullview.png',   title: 'The Pastry Parlour',                             medium: 'Identity Design',       position: 'center center' },
