(function () {
  ...
  var heroSlides = [
    ...
    { src: 'images/bookmark_lunar_mockup.png',     title: '2024 Lunar New Year Bookmark',                   medium: 'Digital Illustration',  position: 'center center' },
    ...
    { src: 'images/chromatic_fragments_mockup.png', title: 'Chromatic Fragments — Exhibition Poster',       medium: 'Digital Illustration',  position: 'center center' },
    ...
    { src: 'images/glow_of_the_road_mockup.png',   title: 'Glow of The Road',                               medium: 'Photographic Print',    position: 'center center' },
    { src: 'images/mural_photo1.jpg',              title: 'Mural',                                          medium: 'Mixed Media',           position: 'center center' },
    { src: 'images/laundry_fullview.jpg',          title: 'What Your Laundry Says About Your Life',         medium: 'Digital Illustration',  position: 'center top' },
