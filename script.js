(function () {
  ...
  var heroSlides = [
    ...
    { src: 'images/lunar_bookmark_thumb.jpg',             title: '2024 Lunar New Year Bookmark',                   medium: 'Digital Illustration',  position: 'center top' },
    { src: 'images/tutoring_thumb.jpg',             title: 'Academic Tutoring Poster',                       medium: 'Digital Illustration',  position: 'center top' },
    { src: 'images/arkade_thumb.png',    title: 'ArKade Mood Board & Website',                    medium: 'Web Design',            position: 'center center' },
    { src: 'images/citymd_thumb.jpg',              title: 'CityMD Logo',                                    medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/coffee_infographic_thumb.jpg',             title: 'Coffee Infographic',                             medium: 'Digital Illustration',  position: 'left top' },
    { src: 'images/starwars_thumb.jpg',             title: 'Star Wars: The Empire Strikes Back Movie Poster', medium: 'Digital Illustration', position: 'center top' },
    { src: 'images/glow_of_the_road_thumb.jpg',             title: 'Glow of The Road',                               medium: 'Photographic Print',    position: 'center center' },
    ...
    { src: 'images/earthly_fullview.jpg',    title: 'Creation of the Earthly — Exhibition Poster',   medium: 'Digital Illustration',  position: 'center top' },
    { src: 'images/mural_fullview.jpg',      title: 'Mural',                                          medium: 'Mixed Media',           position: 'center center' },
    { src: 'images/doors_loop.mp4',          title: 'Doors',                                          medium: 'Video' },
    { src: 'images/the_maker_fullview.jpg',  title: 'The Maker',                                      medium: 'Photographic Print',    position: 'center center' },
    { src: 'images/chromatic_fullview.jpg',  title: 'Chromatic Fragments — Exhibition Poster',        medium: 'Digital Illustration',  position: 'center top' },
    { src: 'images/confrontation_fullview.jpg', title: 'Confrontation',                               medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/passthrough_fullview.jpg',   title: 'Passthrough',                                 medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/branches_fullview.jpg',      title: 'Branches',                                    medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/reach_fullview.jpg',         title: 'Reach',                                       medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/free_flow_fullview.jpg',     title: 'Free Flow',                                   medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/pathway_fullview.jpg',       title: 'Pathway',                                     medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/chains_fullview.jpg',        title: 'Chains',                                      medium: 'Digital Illustration',  position: 'center center' },
    { src: 'images/circuits_fullview.jpg',      title: 'Circuits',                                    medium: 'Digital Illustration',  position: 'center center' },
  ];
